...
func (rt *Transfer) receiveData(f *File, localFile *os.File) error {
	...
	// Windows cannot replace the destination while the basis file is still
	// open. All matched-data reads are complete once the checksum matches.
	if localFile != nil {
