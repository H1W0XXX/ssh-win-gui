...
func (o *Options) Compress() bool             { return o.do_compression != 0 || o.compress_choice != "" }
func (o *Options) CompressChoice() string     { return o.compress_choice }
func (o *Options) CompressionLevel() int {
	if o.do_compression_level == math.MinInt32 {
		return 6
	}
	if o.do_compression_level < 1 {
		return 1
	}
	if o.do_compression_level > 9 {
		return 9
	}
	return o.do_compression_level
}
